var jscolor = {
	...
	color : function(target, prop) {
		...
		this.pickerFaceColor = 'url(\'../img/background.png\')'; // CSS color
		this.pickerBorder = 1; // px
		this.pickerBorderColor = '#000000'; // CSS color
		this.pickerInset = 1; // px
		this.pickerInsetColor = '#000000'; // CSS color
		...
		function drawPicker(x, y) {
			...
			p.padM.style.backgroundImage = "url('./img/cross.gif')";
			p.padM.style.backgroundRepeat = "no-repeat";
			p.sldM.style.backgroundImage = "url('./img/arrow.gif')";
